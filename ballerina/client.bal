...
public isolated client class Client {
    ...
    resource isolated function delete me/albums(me_albums_body_1 payload, map<string|string[]> headers = {}, *RemoveAlbumsUserQueries queries) returns http:Response|error {
    ...
    resource isolated function delete me/audiobooks(map<string|string[]> headers = {}, *RemoveAudiobooksUserQueries queries) returns http:Response|error {
    ...
    resource isolated function delete me/episodes(me_episodes_body_1 payload, map<string|string[]> headers = {}, *RemoveEpisodesUserQueries queries) returns http:Response|error {
    ...
    resource isolated function delete me/following(me_following_body_1 payload, map<string|string[]> headers = {}, *UnfollowArtistsUsersQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Show removed 
    resource isolated function delete me/shows(map<string|string[]> headers = {}, *RemoveShowsUserQueries queries) returns http:Response|error {
    ...
    resource isolated function delete me/tracks(me_tracks_body_1 payload, map<string|string[]> headers = {}, *RemoveTracksUserQueries queries) returns http:Response|error {
    ...
    resource isolated function delete playlists/[string playlist_id]/followers(map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Bad or expired token. This can happen if the user revoked a token or the access token has expired. You should re-authenticate the user. 
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function post me/player/next(map<string|string[]> headers = {}, *SkipUsersPlaybackToNextTrackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function post me/player/previous(map<string|string[]> headers = {}, *SkipUsersPlaybackToPreviousTrackQueries queries) returns http:Response|error {
    ...
    resource isolated function post me/player/queue(map<string|string[]> headers = {}, *AddToQueueQueries queries) returns http:Response|error {
        string resourcePath = string `/me/player/queue`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function put me/albums(me_albums_body payload, map<string|string[]> headers = {}, *SaveAlbumsUserQueries queries) returns http:Response|error {
        string resourcePath = string `/me/albums`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
    ...
    resource isolated function put me/audiobooks(map<string|string[]> headers = {}, *SaveAudiobooksUserQueries queries) returns http:Response|error {
        string resourcePath = string `/me/audiobooks`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    ...
    resource isolated function put me/episodes(me_episodes_body payload, map<string|string[]> headers = {}, *SaveEpisodesUserQueries queries) returns http:Response|error {
        string resourcePath = string `/me/episodes`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
    ...
    resource isolated function put me/following(me_following_body payload, map<string|string[]> headers = {}, *FollowArtistsUsersQueries queries) returns http:Response|error {
        string resourcePath = string `/me/following`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
    ...
    resource isolated function put me/player(me_player_body payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/me/player`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function put me/player/pause(map<string|string[]> headers = {}, *PauseAUsersPlaybackQueries queries) returns http:Response|error {
    ...
    resource isolated function put me/player/play(player_play_body payload, map<string|string[]> headers = {}, *StartAUsersPlaybackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function put me/player/repeat(map<string|string[]> headers = {}, *SetRepeatModeOnUsersPlaybackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function put me/player/seek(map<string|string[]> headers = {}, *SeekToPositionInCurrentlyPlayingTrackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function put me/player/shuffle(map<string|string[]> headers = {}, *ToggleShuffleForUsersPlaybackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Command sent 
    resource isolated function put me/player/volume(map<string|string[]> headers = {}, *SetVolumeForUsersPlaybackQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Show saved 
    resource isolated function put me/shows(map<string|string[]> headers = {}, *SaveShowsUserQueries queries) returns http:Response|error {
        string resourcePath = string `/me/shows`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Track saved 
    resource isolated function put me/tracks(me_tracks_body payload, map<string|string[]> headers = {}, *SaveTracksUserQueries queries) returns http:Response|error {
        string resourcePath = string `/me/tracks`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
    ...
    resource isolated function put playlists/[string playlist_id](playlists_playlist_id_body payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/playlists/${getEncodedUri(playlist_id)}`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function put playlists/[string playlist_id]/followers(playlist_id_followers_body payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/playlists/${getEncodedUri(playlist_id)}/followers`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function put playlists/[string playlist_id]/images(http:Request request, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/playlists/${getEncodedUri(playlist_id)}/images`;
